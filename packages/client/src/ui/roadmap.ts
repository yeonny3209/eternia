...
const MILESTONES: Milestone[] = [
  ...
  },
  {
    ...
    tasks: [
      ...
      { label: '캐릭터 이동/카메라, 맵 로더', status: 'PARTIAL', note: '훈련장 한정. 맵 로더 없음' },
  ...
  },
  {
    ...
    tasks: [
      ...
      { label: '16슬롯 인벤토리/장착, 무기 스왑', status: 'TODO', note: '타입과 DB 스키마만 존재' },
  ...
  },
  {
    ...
    tasks: [
      ...
      { label: '맵 1~3 + 튜토리얼 T-01~T-11', status: 'PARTIAL', note: '퀘스트 데이터 30종 완료, 씬 없음' },
    ],
  },
  {
    id: 'M4',
